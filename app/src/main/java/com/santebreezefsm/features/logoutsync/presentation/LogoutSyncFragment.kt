package com.santebreezefsm.features.logoutsync.presentation
...
import com.santebreezefsm.app.AppDatabase
import com.santebreezefsm.app.NetworkConstant
...
import com.santebreezefsm.app.utils.Toaster
import com.santebreezefsm.base.BaseResponse
import com.santebreezefsm.base.presentation.BaseActivity
import com.santebreezefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.santebreezefsm.features.billing.api.AddBillingRepoProvider
import com.santebreezefsm.features.billing.model.AddBillingInputParamsModel
...
import com.santebreezefsm.features.dashboard.presentation.ReasonDialog
...
import com.santebreezefsm.features.document.model.AddEditDocumentInputParams
import com.santebreezefsm.features.document.model.DocumentAttachmentModel
...
import com.santebreezefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.santebreezefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.santebreezefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.santebreezefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.santebreezefsm.features.orderhistory.model.*
...
import com.santebreezefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.santebreezefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.santebreezefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.santebreezefsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.santebreezefsm.features.timesheet.model.AddTimeSheetInputModel
import com.santebreezefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.santebreezefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.santebreezefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.santebreezefsm.mappackage.SendBrod
import com.santebreezefsm.widgets.AppCustomTextView
import com.santebreezefsm.MonitorService
import com.santebreezefsm.MySingleton
...
import com.santebreezefsm.features.addshop.presentation.ShopExtraContactReq
...
import com.santebreezefsm.features.login.model.GetConcurrentUserResponse
import com.santebreezefsm.features.login.model.WhatsappApiData
import com.santebreezefsm.features.performance.model.Gps_status_list
import com.santebreezefsm.features.performance.model.UpdateGpsInputListParamsModel
import com.santebreezefsm.features.returnsOrder.ReturnProductList
import com.santebreezefsm.features.returnsOrder.ReturnRequest
import com.santebreezefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xsantebreezefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xsantebreezefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xsantebreezefsmlogsample/log.zip").path);
